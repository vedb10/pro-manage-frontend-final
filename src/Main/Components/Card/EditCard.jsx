...
import { savedData, updateCards } from '../../../apis/dashboard'

export default function AddMenu({onCancel,titleprop,priprop,tasksprop,dateprop,cardId}) {
  const [tasks, setTasks] = useState(tasksprop);
  const [newTaskName, setNewTaskName] = useState('');
  const [title, setTitle] = useState(titleprop);
  const [priority, setPriority] = useState(priprop)
